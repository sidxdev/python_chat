...
def startConversation(fromIP, initialProtocol, initialMessage):
    ...
    conversationWindow[fromIP]['ChatLog'] = Text(base, bd=0, bg="white", height="8", width="50", font="Arial",)
    ...
    conversationWindow[fromIP]['scrollbar'] = Scrollbar(base, command=ChatLog.yview, cursor="heart")
    conversationWindow[fromIP]['ChatLog']['yscrollcommand'] = scrollbar.set
    #Create the Send Button to send message
    conversationWindow[fromIP]['SendButton'] = Button(base, font=30, text="Send", width="12", height=5,
                        bd=0, bg="#FFBF00", activebackground="#FACC2E",
                        command=lambda:SendClickAction(fromIP))
    #Create the File Button to send message
    conversationWindow[fromIP]['FileButton'] = Button(base, font=30, text="File", width="6", height=5,
                        bd=0, bg="#00BF00", activebackground="#FACC2E",
                        command=lambda:FileClickActionSend(fromIP))
    #Create the Voice Button to send message
    conversationWindow[fromIP]['VideoButton'] = Button(base, font=30, text="Voice", width="6", height=5,
                        bd=0, bg="#0FFFF0", activebackground="#FACC2E",
                        command=lambda:VideoClickAction(fromIP))
    #Create the box to enter message
    conversationWindow[fromIP]['EntryBox'] = Text(base, bd=0, bg="white",width="29", height="5", font="Arial")
    ...
    conversationWindow[fromIP]['ChatLog'].place(x=6,y=6, height=386, width=370)
